...
def prediksi(df):
    ...
    Weight = pd.read_excel('../Jupyter/Result/Model SVM - over full-n8.xlsx', sheet_name='Weight', index_col=0)
    X_train_initial = pd.read_excel('../Jupyter/Result/Model SVM - over full-n8.xlsx', sheet_name='X_train_initial', index_col=0)
