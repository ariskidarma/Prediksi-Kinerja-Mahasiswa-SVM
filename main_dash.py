...
def main_page():
    ...
    df_oversampling = pd.read_excel('Data/Data Result.xlsx', sheet_name='df_a oversampling')

    ## 10 Fold Afektif dan Kategorikal Afektif
    eval_model = pd.read_excel('Data/Data Result.xlsx', sheet_name='Evaluasi Model')

    ## 10 Fold Hyperparameter Tuning
    eval_hypertune = pd.read_excel('Data/Hyperparameter Tuning.xlsx', sheet_name='Hypertune')

    ## Performance Metrics - Manual vs Library
    eval_svm = pd.read_excel('Data/Data Result.xlsx', sheet_name='Performance SVM')

    # Confusion Matrix SVM
    conf_SVM = pd.read_excel('Data/Data Result.xlsx', sheet_name='Confusion SVM')
